...
public class WatchDialTypeK extends DialBaseLayout {
    private DigitClock mDigitClock;

    public WatchDialTypeK(Context context) {
        super(context);
    }

    public WatchDialTypeK(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public WatchDialTypeK(Context context, AttributeSet attrs, int defStyle) {
