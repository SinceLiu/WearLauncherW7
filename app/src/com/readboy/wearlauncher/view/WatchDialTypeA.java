 ...
 */
public class WatchDialTypeA extends DialBaseLayout{

    private DigitClock mDigitClock;

    public WatchDialTypeA(Context context) {
        super(context);
    }

    public WatchDialTypeA(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public WatchDialTypeA(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setDate(){
        ...
        String dateFormat = String.format("%d年%d月%d日 %s",year,month,day,WatchController.WEEK_NAME_CN_SHORT[week]);
