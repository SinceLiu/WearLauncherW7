 ...
 *
 * @see android.support.v4.widget.ViewDragHelper
 */
...
public class ViewDragHelper {
     ...
     * but {@link ViewDragHelper.Callback#tryCaptureView(View, int)} will not be asked permission to
     * capture this view.
     *
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                if (mDragState == STATE_DRAGGING) {
                    ...
                    final int offsetX = (int) (x - mInitialMotionX[mActivePointerId]);
                    final int offsetY = (int) (y - mInitialMotionX[mActivePointerId]);
                    //region change this code by oubin
//                    dragTo(mCapturedView.getLeft() + idx, mCapturedView.getTop() + idy, idx, idy);
                    dragTo(offsetX, offsetY, idx, idy);
                    //endregion
