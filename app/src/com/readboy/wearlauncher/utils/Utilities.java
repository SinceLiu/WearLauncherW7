...
public final class Utilities {
    ...
    public static Bitmap getIconFromCursor(Cursor c, int iconIndex, Context context) {


        byte[] data = c.getBlob(iconIndex);
        Log.e("getIconFromCursor","data = "+data+"data.length = "+data.length);
        try {
            return Utilities.resampleIconBitmap(
