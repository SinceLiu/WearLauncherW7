...
class WifiIcons {
    ...
    static final int[] WIFI_SIGNAL_DATA_INOUT = {
            R.drawable.stat_sys_wifi_data_null,
            R.drawable.stat_sys_wifi_data_in,
            R.drawable.stat_sys_wifi_data_out,
            R.drawable.stat_sys_wifi_data_inout};
    static final int[] WIFI_SIGNAL_INOUT = {
            R.drawable.stat_sys_wifi_null,
