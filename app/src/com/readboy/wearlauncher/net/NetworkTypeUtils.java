...
public class NetworkTypeUtils {
    ...
    public static final int[] WFCICON = {R.drawable.stat_sys_wfc1,
            R.drawable.stat_sys_wfc2};
     ...
     */
    public static int getNetworkTypeIcon(ServiceState serviceState, NetworkController.Config config,
                                         boolean hasService) {
        if (!hasService) {
